    ...
    return (
      <div className={cn('relative', containerClassName)}>
        <input
          ...
          aria-label={label}
          className={cn(
            'peer flex h-9 w-full rounded-lg border border-border-light bg-transparent px-3 py-2 text-sm text-text-primary ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
            className,
          )}
          {...props}
        />
