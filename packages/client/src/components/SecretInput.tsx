    ...
    return (
      <div className={cn('group/secret-input relative', containerClassName)}>
        <input
          ...
          className={cn(
            'flex h-10 w-full rounded-lg border border-border-light bg-transparent py-2 pl-3 text-sm text-text-primary transition-colors placeholder:text-muted-foreground hover:border-border-medium focus-visible:border-border-heavy focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
            className ?? '',
